    ...
    <form class="layui-form" action=" " onsubmit="return false" >
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline" style="width: 190px">
                <input  type="text" id="linkUrl" name="linkUrl" required  lay-verify="required" placeholder="请输入连接地址" autocomplete="off" class="layui-input">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="linkName"  name="linkName" required lay-verify="required" placeholder="请输入连接名称" autocomplete="off" class="layui-input">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text"  id="linkSort" name="linkSort" required lay-verify="required" placeholder="请输入连接排序的顺序" autocomplete="off" class="layui-input">
            </div>
            <span id="err2"></span>
        </div>
<%--        <div class="layui-form-item">--%>
