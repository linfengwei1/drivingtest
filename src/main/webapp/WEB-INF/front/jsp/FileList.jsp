...
<head>
	...
	<script src="${pageContext.request.contextPath}/back/js/filelist.js" type="text/javascript" charset="UTF-8"></script>
</head>
...
<script type="text/html" id="barDemo">
	<a class="layui-btn layui-btn-xs" lay-event="dowload">下载</a>
	<a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="pass">审核通过</a>
	<a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="out">审核不通过</a>
</script>
