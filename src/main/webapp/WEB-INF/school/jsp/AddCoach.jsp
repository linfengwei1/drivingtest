...
<head>
    ...
    <script src="${pageContext.request.contextPath}/static/school/js/AddCoach.js" type="text/javascript" charset="UTF-8"></script>
    <style>
        .layui-main-login {
            margin-top: 7%;
            margin-left: 20%;
...
<div class="layui-main-login">
    <form class="layui-form" action=" " onsubmit="return false" >
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text"   onkeyup="value=value.replace(/^(0+)|[^\d]+/g,'')" id="age" name="age" required lay-verify="required" maxlength="2" placeholder="请输入年龄" autocomplete="off" class="layui-input">
            </div>
        </div>
        <!--************这里是上传图片的代码***************-->
