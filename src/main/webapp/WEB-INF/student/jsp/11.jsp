...
<head>
	...
	<link href="${pageContext.request.contextPath}/front/css/video-js.min.css" rel="stylesheet">
	<meta charset="utf-8">
	<title></title>
	...
	<script src="${pageContext.request.contextPath}/front/js/12.js" type="text/javascript" charset="utf-8"></script>
...
<div class="m">
	<video id="my-video" class="video-js vjs-big-play-centered" controls preload="auto" width="960" height="400"
		...
		<source src="${pageContext.request.contextPath}/file/1.mp4" type="video/mp4">
