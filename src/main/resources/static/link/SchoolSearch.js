...
layui.use(['upload', 'jquery', 'layer','table','laydate'], function () { //导入模块
    ...
    table.render({
        ...
        , cols: [[ //表头
            ...
            , {field: 'address', title: '地址', width: 120, sort: true, align: 'center'}
            , {field: 'admin', title: '负责人', width: 120, sort: true, align: 'center'}
            , {field: 'intro', title: '驾校简介', width: 120, sort: true, align: 'center'}
            , {field: 'school_state_id', title: '学校状态ID', width: 120, sort: true, align: 'center'}
            , {field: 'information', title: '学校信息', width: 120, sort: true, align: 'center'}
            , {field: 'audit_results', title: '审核结果', width: 120, sort: true, align: 'center'}
