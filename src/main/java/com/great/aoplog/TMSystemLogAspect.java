...
@Aspect
@Component
public class TMSystemLogAspect {
...
//    @Resource  //这里我用resource注解
  ...
  //这里的zxtest要和log4j.properties里的配置一致，否则写不到文件中
    ...
    @Pointcut("execution (* com.great.service.serviceimpl.TransportationServiceImp.*(..))&& @annotation(com.great.aoplog.Log)")
...
//      }
    ...
    public  void after(JoinPoint joinPoint) throws Throwable {
        ...
        //读取session中的用户
        Transportation transportation = (Transportation) session.getAttribute("Transportation");
        //请求的IP
...
//            System.out.println("请求IP:" + ip);
            //*========数据库日志=========*//  
            TbLog log = new TbLog();
            log.setName(transportation.getName());//操作用户
