...
public class FaceRecognitionUtils
{
	...
	//设置APPID/AK/SK
	public static final String APP_ID = "19374058";
	public static final String API_KEY = "RDNym94v4VPYohDNEpInrwz3";
	public static final String SECRET_KEY = "1hGlq1a22fn4owBCK4yw9xrLdh3DOKqv";
...
//        client.setSocketProxy("proxy_host", proxy_port);  // 设置socket代理
	 ...
	 * @param name
	 */
	public static String faceRegister(String imageString,String name){
		// 传入可选参数调用接口，根据需求自行设置
		String result = null;
		HashMap<String, String> options = new HashMap<String, String>(10);
		String imageType = "BASE64";
