...
public class Student1111111111111
{
	private int id;
	...
	public Student1111111111111()
	{
	}

	public Student1111111111111(int id, String account, String pwd, String name, String sex, String age, String idNumber, String phone, int student_state_id, int school_id, String verification)
	{
		this.id = id;
